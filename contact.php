		...
		<div class="main-container">
			...
			<section class="contact-center">
				<div class="container">
					...
					<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center">
							<h1>Have questions? <br>Wine tastings?<br></h1>
							<p class="lead">contact@windingwillows.com
							<br>+1-705-607-WINE<br>12888 6th Line,&nbsp;Limehouse Ontario</p>
						</div><div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
							<div class="form-wrapper clearfix">
								<form class="form-contact email-form" method="post" action="registercontact.php">
									<div class="inputs-wrapper">
										<input class="form-name validate-required" type="text" placeholder="Your Name" name="username">
										<input class="form-email validate-required validate-email" type="text" name="email" placeholder="Your Email Address">
										<textarea class="form-message validate-required" name="comments" placeholder="Your Message"></textarea>
									</div>
			...
			<section class="map">
				<div class="map-holder">
					<iframe src="https://maps.google.com/maps?q=12888%206th%20Line%20Limehouse,%20Ontario&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
				</div>
			</section>
		</div>
